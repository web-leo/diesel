   ...
   $.paginate = function (element, options) {
      ...
      var generatePagination = function () {
         var paginationEl =
            ...
            ' class="paginate-pagination paginate-pagination-' +
            plugin_index +
            '" data-parent="' +
            plugin_index +
            '">';
         ...
         paginationEl +=
            ...
            ' href="#" data-page="prev" class="page page-prev pagination_arrow_prev"></' +
            plugin.settings.linkTag +
            ">";
         paginationEl += "</" + plugin.settings.itemTag + ">";
         ...
         paginationEl +=
            "<" +
            plugin.settings.linkTag +
            ' href="#" data-page="next" class="page page-next pagination_arrow_next"></' +
            plugin.settings.linkTag +
            ">";
         paginationEl += "</" + plugin.settings.itemTag + ">";
            ...
            function (e) {
               ...
               if (page) {
                  ...
                  if (plugin.settings.autoScroll)
                     $("html, body").animate(
                        {
                           scrollTop: $(".paginate-" + paginateParent).offset()
                              .top,
                        },
                        "slow"
                     );
